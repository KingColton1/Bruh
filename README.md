...
6. [Features](#6-features)
   ...
   - [6.4 Auto-Thread Channel](#64-auto-thread-channel)
   - [6.5 Chicken Out Detection](#65-chicken-out-detection)
   - [6.6 !hbm Command](#66-hbm-command)
